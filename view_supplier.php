...
<div class="container-fluid">
    <div class="col-12">
        ...
        <div class="w-100 mb-1">
            <div class="fs-6"><b>Supplier Contact:</b></div>
            <div class="fs-5 ps-4"><?php echo isset($supplier_contact) ? $supplier_contact : '' ?></div>
        </div>
        <div class="w-100 mb-1">
            <div class="fs-6"><b>Supplier Address:</b></div>
            <div class="fs-5 ps-4"><?php echo isset($supplier_address) ? $supplier_address : '' ?></div>
        </div>
        <div class="w-100 mb-1">

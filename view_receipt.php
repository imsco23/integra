...
// Fetch remarks
$remarks_query = $conn->query("SELECT remarks FROM `transaction_list` WHERE transaction_id = '{$_GET['id']}'");
$remarks_row = $remarks_query->fetch_assoc();
$remarks = isset($remarks_row['remarks']) ? $remarks_row['remarks'] : '';
?>
<style>
...
<div class="container-fluid">
    <div id="outprint_receipt">
        <div class="text-center fw-bold lh-1">
            <span>Integra Medica Solutions Corp. Management System</span><br>
            <small>Receipt</small>
        </div>
        <div class="fs-6 fs-light d-flex w-100 mb-1 fw-bold">
        ...
        <div class="fs-6 fs-light d-flex w-100 mb-1 fw-bold">
            <span class="col-auto pe-2">Patient Name:</span>
            <span class="border-bottom border-dark flex-grow-1"><?php echo isset($patient_name) ? $patient_name : '' ?></span>
        </div>
        <div class="fs-6 fs-light d-flex w-100 mb-1 fw-bold">
            <span class="col-auto pe-2">Surgeon:</span>
            <span class="border-bottom border-dark flex-grow-1"><?php echo isset($surgeon) ? $surgeon : '' ?></span>
        </div>
        <div class="fs-6 fs-light d-flex w-100 mb-1 fw-bold">
            <span class="col-auto pe-2">Hospital:</span>
            <span class="border-bottom border-dark flex-grow-1"><?php echo isset($hospital) ? $hospital : '' ?></span>
        </div>
        <div class="fs-6 fs-light d-flex w-100 mb-1 fw-bold">
            <span class="col-auto pe-2">Technician:</span>
            <span class="border-bottom border-dark flex-grow-1"><?php echo isset($technician) ? $technician : '' ?></span>
        </div>
        <div class="fs-6 fs-light d-flex w-100 mb-3 fw-bold">
            <span class="col-auto pe-2">Sales Invoice No.:</span>
            <span class="border-bottom border-dark flex-grow-1"><?php echo isset($sales_invoice) ? $sales_invoice : '' ?></span>
        </div>
        <div class="fs-6 fs-light d-flex w-100 mb-3 fw-bold">
            <span class="col-auto pe-2">Remarks:</span>
            <span class="border-bottom border-dark flex-grow-1"><?php echo $remarks ?></span>
        </div>
        <div class="fs-6 fs-light d-flex w-100 mb-3 fw-bold">
            <span class="col-auto pe-2">SETS:</span>
            <span class="border-bottom border-dark flex-grow-1"><?php echo $sets ?></span>
        </div>

            ...
            <div class="row">
                <div class="col-md-6">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="sku" autofocus id="sku" required class="form-control form-control-sm rounded-0" value="<?php echo isset($sku) ? $sku : '' ?>">
                    </div>
                    <div class="form-group">
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <select name="supplier_id" id="supplier_id" class="form-select form-select-sm rounded-0 select2" required>

...
if(isset($_GET['id'])){
$qry = $conn->query("SELECT p.*,c.name as cname, s.name AS supplier_name
 FROM `product_list` p 
 inner join `category_list` c on p.category_id = c.category_id 
 LEFT JOIN `supplier_list` s ON p.supplier_id = s.supplier_id
...
<div class="container-fluid">
    <div class="col-12">
        ...
        <div class="w-100 mb-1">
            <div class="fs-6"><b>Supplier:</b></div>
            <div class="fs-6 ps-4"><?php echo isset($supplier_name) ? $supplier_name : 'Not Available' ?></div>
        </div>

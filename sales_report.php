        ...
        <table class="table table-hover table-striped table-bordered">
            ...
            <thead>
                <tr>
                    ...
                    <th class="text-center p-0">Patient Name</th>
                    <th class="text-center p-0">Item No.</th>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="py-0 px-1"><a href="javascript:void(0)" class="view_data" data-id="<?php echo $row['transaction_id'] ?>"><?php echo $row['patient_name'] ?></a></td>
                    <td class="py-0 px-1 text-center"><?php echo format_num($items) ?></td>
                    <td class="py-0 px-1 text-center"><?php echo format_num($row['total']) ?></td>

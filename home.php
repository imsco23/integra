                                ...
                                <tbody>
                                    <?php
                                        ...
                                        while($row = $qry->fetch_assoc()):
                                            ...
                                            $qty = $qty > 0 ? $qty : 0;
                                    ?>
                                        <tr class="<?php echo $qty < 50 ? 'bg-danger bg-opacity-10' : ''; ?>">
                                            <td class="py-0 px-3 text-nowrap"><?php echo $row['cname']; ?></td>
                                            <td class="py-0 px-3 text-nowrap"><?php echo $row['name']; ?></td>

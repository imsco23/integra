                ...
                <div class="col-md-12">
                    ...
                    <div class="form-group">
                        ...
                        <select name="product_id" id="product_id" class="form-select form-select-sm rounded-0 select2" required >
                            ...
                            ?>
                                <option value="<?php echo $row['product_id'] ?>" <?php echo ((isset($product_id) && $product_id == $row['product_id']) || (isset($_GET['pid']) && $_GET['pid'] == $row['product_id']) ) ? 'selected' : '' ?>>
                                    <?php echo $row['name'].' - '.$row['sku'] ?>
                                </option>
                            <?php endwhile; ?>
                        </select>
                    </div>
